...
const ImörsHistory = ({ email, username }) => {
  ...
  const historyRecords = [
    ...
    { modelName: 'Model B', songName: 'Song B', videoUrl: 'http://example.com/video2' },
    { modelName: 'Model C', songName: 'Song C', videoUrl: 'http://example.com/video3' }
  ];
    ...
    <div id="container">
      <div id="navbar">
        ...
        <div>
          ...
          <div className="sidebar_container2" onClick={() => navigate('/MyFavorites')}>
            My Favorites
          </div>
        </div>
      </div>
