  ...
  return (
    <div className="Homepage">
      <div className="sidebar">
        <div className='logo_container'><img className='homepage_img_input' src="logo.png" alt="Unloadable" /></div>
        <div className='sidebar_container1'>
          <div><button className='sidebar-avatar_button'>{avatar && (
            <img onClick={goToHomepage2} className='avatar_uploaded_homepage' src={avatar} />
          )}</button></div>
